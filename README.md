...
- **AI-Powered Analysis** — Deep, contextual analysis powered by Groq's qwen/qwen3.6-27b model
...
| Groq API (qwen/qwen3.6-27b) | AI-powered analysis & bullet generation |
...
│   ├── utils/
│   │   ├── aiAnalyzer.js            # Groq API integration (qwen/qwen3.6-27b)
...
4. **AI Analysis** — The full resume and JD text are sent to Groq's qwen/qwen3.6-27b model, which returns:
...
- [qwen/qwen3.6-27b](https://groq.com) — Open-source large language model
